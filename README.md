...
### 27. 从 VLA/WAM 到 G1 控制接口

- 动作语义、参考坐标系、时间戳、更新频率、动作维度和限幅规则
- 动作块的执行、截断、刷新和轨迹衔接
- 数值、运动学、动力学、稳定性和碰撞检查
- VLA/WAM 输出经 IK、轨迹规划、WBC 和安全过滤进入 G1 关节接口
...
- 中英文术语、缩写、官方 G1 仓库、SDK、ROS 2、MuJoCo、Isaac Lab、RL Gym、VLA、WAM 和机器人学习论文。
