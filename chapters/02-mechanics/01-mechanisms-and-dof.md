...
这里的“雅可比接近奇异”与[第 4.1 节的欧拉角万向节锁](../04-algorithms-software/01-robot-mathematics-foundations.md#与四连杆死点的联系)有一个重要联系：两者都表现为局部变量到物理量的映射秩下降或条件数恶化，但四连杆死点是实际机构的传动退化，万向节锁只是姿态参数化的表示退化。前者会改变输出运动和负载能力，后者不会让机器人刚体凭空少一个自由度。
