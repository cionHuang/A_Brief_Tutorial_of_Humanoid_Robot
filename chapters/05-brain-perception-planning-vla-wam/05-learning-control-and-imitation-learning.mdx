...
这也解释了为什么第 6 章的日志、数据集与版本管理不是“工具而已”（见 [6.6 节](../06-software-tools-simulation/06-software-engineering-and-versioning.md)）：没有它们，闭环的每一圈都要从头再来一遍；有了它们，失败样本才会自动变成下一轮训练数据。评测怎么做、为什么“演示成功”不等于“能力达标”，见 [5.6 节](../05-brain-perception-planning-vla-wam/06-vla-and-advanced-ai.mdx)。
