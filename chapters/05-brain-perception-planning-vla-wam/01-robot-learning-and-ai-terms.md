...
先交代两个后面反复出现的缩写：**VLA**（Vision-Language-Action，视觉-语言-动作模型，见 5.6 节）与 **WAM**（World Action Model，世界动作模型，见 5.7 节）。也先划清章节边界：第五章是**大脑**层（感知、规划、操作、学习、VLA/WAM），回答“去做什么”；**小脑**层（状态估计、平衡与全身控制）是第四章，回答“这一毫秒怎么动”。
