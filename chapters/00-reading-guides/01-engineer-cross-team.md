...
| 4 | [4.6 双足平衡与全身控制](../04-cerebellum-realtime-control/06-balance-and-whole-body-control.mdx) | ZMP、支撑域、全身控制任务栈 | 读前半 |
...
| 4 | [5.6 VLA 与高级 AI 推理模型](../05-brain-perception-planning-vla-wam/06-vla-and-advanced-ai.md) | 大模型输出如何一步步变成关节动作 | 读前半 |
