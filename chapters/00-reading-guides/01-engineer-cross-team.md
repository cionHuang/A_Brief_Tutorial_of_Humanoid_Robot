...
建议先花 30 分钟读 [1.3 人形机器人系统架构](../01-system-overview/03-humanoid-robot-system-architecture.mdx) 与 [1.4 从一句话到电机：整机总图](../01-system-overview/04-from-task-to-motor.mdx)：1.3 讲分层与接口，1.4 给整张总图（各层频率、跑在哪、两个闭环）；然后对号入座：你这周要和谁开会、和谁联调，就按对应的表读。
