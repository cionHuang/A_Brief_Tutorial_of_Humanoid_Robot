...
*图：Intel RealSense D435 深度相机实拍。深度相机可以把环境几何转换为距离或点云，是人形机器人感知系统的常用输入。作者：[Marc Auledas](https://commons.wikimedia.org/wiki/User:Auledas)；来源：[Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Intel_Realsense_depth_camera_D435.jpg)；授权：[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)。*
...
*图：Shadow Dexterous Hand 多指灵巧手实拍。相比夹爪，灵巧手通过多个手指关节完成更丰富的接触和抓取动作，是末端执行器的一种典型形态。作者：Richard Greenhill 与 Hugo Elias（Shadow Robot Company）；来源：[Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Shadow_Hand_Bulb_large.jpg)；授权：[CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/)。*
...
> **一句话听懂**：描述文件就是机器人的“机器可读说明书”——机械按它交付，算法按它计算，双方对的是同一份文本。
